...
int TMVAClassification_v8( TString myMethodList = "" )
{
   ...
   //   TString fname = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/80x_trainingTrees_v0/ttH_bdtTraining_rand40_tree.root";
