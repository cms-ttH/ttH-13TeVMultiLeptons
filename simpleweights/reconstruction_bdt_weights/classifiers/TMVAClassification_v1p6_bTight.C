...
int TMVAClassification_v1p6_bTight( TString myMethodList = "" )
{
   ...
   TString fname = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/80x_trainingTrees_v1_btightloose/ttH_bTight_bdtTraining_ss_os.root";
   TString fname_bkg = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/80x_trainingTrees_v1_btightloose/ttbar_mgMLM_bTight_bdtTraining_ss.root";
   ...
   factory->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=13000:nTrain_Background=20000:SplitMode=Random:NormMode=NumEvents:!V" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_v1p6_bTight(methodList); 
}
