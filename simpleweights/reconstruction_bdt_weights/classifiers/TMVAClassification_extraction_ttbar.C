...
int TMVAClassification_extraction_ttbar( TString myMethodList = "" )
{
   ...
   //   TString fname_sig_train = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/signal_extraction/training/tth_pow_relaxed_2lss_bdtEval_v1p5.root";
   ...
   //   TString fname_bkg_train = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/signal_extraction/training/ttbar_semilep_mg5mlm_2lss_bdtEval_v1p5.root";
   ...
   //   TString fname_bkg_test = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/bdt_v1p5_bTightLoose/ttV_bdtEval.root";
   ...
   factory->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=30000:nTrain_Background=27000:SplitMode=Random:NormMode=NumEvents:!V" );
