...
int TMVAClassification_v1p5_bLoose( TString myMethodList = "" )
{
   ...
   factory->AddVariable( "dR_b_W_lepTop","dR(lep,b) from leptop","dR",'D');   
   ...
   TString fname = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/80x_trainingTrees_v1_btightloose/ttH_bLoose_bdtTraining_ss_os.root";
   TString fname_bkg = "/afs/cern.ch/user/m/muell149/work/CMSSW_8_0_13/src/ttH-13TeVMultiLeptons/TemplateMakers/test/reco_bdt/80x_trainingTrees_v1_btightloose/ttbar_mgMLM_bLoose_bdtTraining_ss.root";
   ...
   TTree *signal     = (TTree*)input->Get("signal_tree");
   ...
   factory->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=20000:nTrain_Background=30000:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod( TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=1000:MinNodeSize=4.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=20:MaxDepth=3" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_v1p5_bLoose(methodList); 
}
