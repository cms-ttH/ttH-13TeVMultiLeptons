...
int TMVAClassification_signalExtraction_ttbar_ICHEP( TString myMethodList = "" )
{
   ...
   factory->AddVariable( "numJets_float","njets","njets",'D');
   factory->AddVariable( "mindr_lep1_jet","dR (lep1, closest jet)","dR",'D');
   factory->AddVariable( "mindr_lep2_jet","dR (lep2, closest jet)","dR",'D');
   factory->AddVariable( "MT_met_lep1","MT lep1, MET","transverse mass",'D');
   ...
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod( TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=200:NNodesMax=5:BoostType=Grad:Shrinkage=0.10:BaggedSampleFraction=0.6:nCuts=200:MaxDepth=8:nEventsMin=100" );
   //                           "!H:!V:NTrees=200:NNodesMax=5:BoostType=Grad:Shrinkage=0.10:BaggedSampleFraction=0.6:nCuts=200:MaxDepth=2:MinNodeSize=0.0813623.2:nEventsMin=100" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_signalExtraction_ttbar_ICHEP(methodList); 
}
