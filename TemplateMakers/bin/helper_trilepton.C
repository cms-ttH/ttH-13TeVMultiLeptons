...
//   // Book the histograms
  ...
  if (CoreVariables) {
    ...
    intBranches["TwoMuonEle"] = new int (0);
    intBranches["TwoEleMuon"] = new int (0);
    ...
    floatBranches["mass_leplep_1"] = new float(0.0);
    floatBranches["mass_leplep_2"] = new float(0.0);
    floatBranches["pt_leplep"] = new float(0.0);
    floatBranches["pt_leplep_1"] = new float(0.0);
    floatBranches["pt_leplep_2"] = new float(0.0);
    floatBranches["dPhi_leplep"] = new float(0.0);
    floatBranches["dPhi_leplep_1"] = new float(0.0);
    floatBranches["dPhi_leplep_2"] = new float(0.0);
    floatBranches["dR_leplep"] = new float(0.0);
    floatBranches["dR_leplep_1"] = new float(0.0);
    floatBranches["dR_leplep_2"] = new float(0.0);
    floatBranches["correctedDZ_leplep"] = new float(0.0);
    floatBranches["correctedDZ_leplep_1"] = new float(0.0);
    floatBranches["correctedDZ_leplep_2"] = new float(0.0);
    floatBranches["correctedD0_leplep"] = new float(0.0);
    floatBranches["correctedD0_leplep_1"] = new float(0.0);
    floatBranches["correctedD0_leplep_2"] = new float(0.0);
    floatBranches["tkDZ_leplep"] = new float(0.0);
    floatBranches["tkDZ_leplep_1"] = new float(0.0);
    floatBranches["tkDZ_leplep_2"] = new float(0.0);
  ...
  if (ExtraSameSignVariables) {
    ...
    floatBranches["lep3FlipSF"] = new float (0.0);
...
//     floatBranches["min_dr_genB2_allJet"] = new float (0.0);
  ...
  if (ExtraKinematicVariables) {
    ...
    floatBranches["dEta_leplep_1"] = new float(0.0);
    floatBranches["dEta_leplep_2"] = new float(0.0);
    floatBranches["MT_met_lep1"] = new float(0.0);
    floatBranches["MT_met_lep2"] = new float(0.0);
    floatBranches["MT_met_lep3"] = new float(0.0);
    floatBranches["dPhi_met_lep1"] = new float(0.0);
    floatBranches["dPhi_met_lep2"] = new float(0.0);
    floatBranches["dPhi_met_lep3"] = new float(0.0);
    ////everything
  ...
  intBranches["lep3NumTrackHits"] = new int (0);  
  intBranches["lep3NumPixelHits"] = new int (0);  
  intBranches["lep3NumberOfMatches"] = new int (0);  
  floatBranches["lep3Chi2"] = new float (0.0);
  intBranches["lep3NumExpectedHits"] = new int (0);
...
//       break;
    ...
    bool PassThreeLepton = (( numTightMuons + numLooseMuons + numTightElectrons + numLooseElectrons )== 3 && ( numTightMuons + numTightElectrons )> 0 );
    //if ( !PassThreeLepton ) continue ;
    if ( debug_ && muons.size() + electrons.size() > 3 ) cout << "Event " << cnt << ", Input collection of leptons greater than 3" << endl;
    if ( !PassThreeLepton ) {
      continue;
    }
    ...
    TLorentzVector lep_vect_1_2;
    TLorentzVector lep_vect_1_3;
    TLorentzVector lep_vect_2_3;
    float mass_1_2 = dFloat;
    float mass_1_3 = dFloat;
    float mass_2_3 = dFloat;
    
    if (numTightMuons + numLooseMuons == 3) {
      ...
      if ( fabs(91-mass_1_2) > fabs(91-mass_1_3) || fabs(91-mass_1_2) > fabs(91-mass_2_3) ) {
        if ( fabs(91-mass_1_3) > fabs(91-mass_2_3) ) {
          muonsSelected.at(0) = muonsTL.at(1);
          muonsSelected.at(1) = muonsTL.at(2);
          muonsSelected.at(2) = muonsTL.at(0);
        } else {
          muonsSelected.at(1) = muonsTL.at(2);
          muonsSelected.at(2) = muonsTL.at(1);
        }
      }
    } // End if numTightMuons + numLooseMuons == 3

    if (numTightElectrons + numLooseElectrons == 3) {
      ...
      if ( fabs(91-mass_1_2) > fabs(91-mass_1_3) || fabs(91-mass_1_2) > fabs(91-mass_2_3) ) {
        if ( fabs(91-mass_1_3) > fabs(91-mass_2_3) ) {
          electronsSelected.at(0) = electronsTL.at(1);
          electronsSelected.at(1) = electronsTL.at(2);
          electronsSelected.at(2) = electronsTL.at(0);
        } else {
          electronsSelected.at(1) = electronsTL.at(2);
          electronsSelected.at(2) = electronsTL.at(1);
        }
      }
    } // End if numTightElectrons + numLooseElectrons == 3

    
//     BNmuonCollection muonsSelected2 = muonsSelected;
//     BNelectronCollection electronsSelected2 = electronsSelected;
//     BNmuonCollection muonsEmpty;
//     BNelectronCollection electronsEmpty;
    
//     if (muonsSelected.size() > 1) {
//       muonsSelected2.at(0) = muonsSelected.at(1);
//       cout << "muonsSelected2 pT 1 = " << muonsSelected2.at(0).pt << endl;
//       cout << "muonsSelected2 pT 2 = " << muonsSelected2.at(1).pt << endl;
//       muonsSelected = muonsEmpty;
//       cout << "muonsSelected2 eta = " << muonsSelected2.at(0).eta << endl;
//     }
//     if (electronsSelected.size() > 1) {
//       electronsSelected2.at(0) = electronsSelected.at(1);
//       cout << "electronsSelected2 pT 1 = " << electronsSelected2.at(0).pt << endl;
//       cout << "electronsSelected2 pT 2 = " << electronsSelected2.at(1).pt << endl;
//       electronsSelected = electronsEmpty;
//       cout << "electronsSelected2 eta = " << electronsSelected2.at(0).eta << endl;
//     }
//     muonsSelected = muonsTL;
//     electronsSelected = electronsTL;
...
//     }
    ...
    good_jet_charge.push_back(jetcharge);
      ...
      bool ThreeMuon = PassThreeLepton && ( numTightMuons + numLooseMuons == 3);
      bool TwoMuonEle = PassThreeLepton && ( numTightMuons + numLooseMuons == 2);
      bool TwoEleMuon = PassThreeLepton && ( numTightMuons + numLooseMuons == 1);
      bool ThreeEle = PassThreeLepton && ( numTightMuons + numLooseMuons == 0);

      if (debug_ && ThreeMuon) cout << "ThreeMuon event" << endl;
      if (debug_ && TwoMuonEle) cout << "TwoMuonEle event" << endl;
      if (debug_ && TwoEleMuon) cout << "TwoEleMuon event" << endl;
      if (debug_ && ThreeEle) cout << "ThreeEle event" << endl;
	...
	sum_allJet_vect += allJetV[sumv];
      ...
      TLorentzVector lep_vect3_transverse;
      ...
      if ( PassThreeLepton ){  //////// number of jets and number of tags
   ...
   int lep3numberOfValidMuonHits = dInt;
	...
	lep3numberOfValidMuonHits = muonsSelected.at(2).numberOfValidMuonHits;
        ...
        if (lep3GenID == -99) {
          MCLep3 = beanHelper.GetMatchedMCparticle(mcparticles,muonsSelected.at(2),0.1);
          if (MCLep3.id != -99 && abs(MCLep3.id) != 6 && abs(MCLep3.id) != 23 && abs(MCLep3.id) != 24 && abs(MCLep3.id) != 25) {
            lep3GenID = MCLep3.id;
            lep3GenMotherID = MCLep3.motherId;
            lep3GenCharge = MCLep3.charge;
          }
        }
        ...
        if (selectionYearStr == "2011") {
          ...
          lep3Iso = (muonsSelected.at(2).chargedHadronIso
                      + muonsSelected.at(2).neutralHadronIso
                      + muonsSelected.at(2).photonIso) * 1.0 / lep3Pt;

          lep1ChargedIso = muonsSelected.at(0).chargedHadronIso / lep1Pt;
          lep2ChargedIso = muonsSelected.at(1).chargedHadronIso / lep2Pt;
          lep3ChargedIso = muonsSelected.at(2).chargedHadronIso / lep3Pt;
        }
        else if (selectionYearStr == "2012_52x" || selectionYearStr == "2012_53x") {
          ...
          lep3Iso = (muonsSelected.at(2).pfIsoR04SumChargedHadronPt
                      + max(0.0, muonsSelected.at(2).pfIsoR04SumNeutralHadronEt
                                 + muonsSelected.at(2).pfIsoR04SumPhotonEt
                                 - 0.5*muonsSelected.at(2).pfIsoR04SumPUPt)) * 1.0 /lep3Pt;
          ...
          lep3ChargedIso = muonsSelected.at(2).pfIsoR04SumChargedHadronPt /lep3Pt;
        }
        else {
          assert (selectionYearStr == "either 2012_52x, 2012_53x, or 2011");
        }
        ...
        lep3NeutralIso = lep3Iso - lep3ChargedIso;
        ...
        lep_vect3_transverse.SetPxPyPzE(muonsSelected.at(2).px, muonsSelected.at(2).py,
                                        0.0, sqrt(pow(muonsSelected.at(2).energy,2) - pow(muonsSelected.at(2).pz,2)));

        if (isData) { lep1FlipSF = 1.0; lep2FlipSF = 1.0; lep3FlipSF = 1.0; lep1PromptSF = 1.0; lep2PromptSF = 1.0; lep3PromptSF = 1.0;}
        else {
          lep1FlipSF = 1.0;
          lep2FlipSF = 1.0;
          lep3FlipSF = 1.0;
          ...
          lep3PromptSF = 1.0; //Some function
        }
        ...
        lep3PassSSCut = (muonsSelected.at(2).numberOfValidTrackerHitsInnerTrack > 7);
	  ...
	  if( ThreeEle ) {
        ...
        if (lep3GenID == -99) {
          MCLep3 = beanHelper.GetMatchedMCparticle(mcparticles,electronsSelected.at(2),0.1);
          if (MCLep3.id != -99 && abs(MCLep3.id) != 6 && abs(MCLep3.id) != 23 && abs(MCLep3.id) != 24 && abs(MCLep3.id) != 25) {
            lep3GenID = MCLep3.id;
            lep3GenMotherID = MCLep3.motherId;
            lep3GenCharge = MCLep3.charge;
        ...
        if (selectionYearStr == "2011") {
          ...
          lep3Iso = (electronsSelected.at(2).chargedHadronIso
                      + electronsSelected.at(2).neutralHadronIso
                      + electronsSelected.at(2).photonIso) * 1.0 / lep3Pt;
        }
        else if (selectionYearStr == "2012_52x" || selectionYearStr == "2012_53x") {
          lep1Iso = ( electronsSelected.at(0).chargedHadronIso
          ...
          lep3Iso = ( electronsSelected.at(2).chargedHadronIso
                       + max(0.0, electronsSelected.at(2).neutralHadronIso
                                  + electronsSelected.at(2).photonIso
                                  - electronsSelected.at(2).AEffDr03*electronsSelected.at(2).rhoPrime) ) * 1.0 /lep3Pt;
        ...
        lep3ChargedIso = electronsSelected.at(2).chargedHadronIso /lep3Pt;
	    ...
	    lep_vect3_transverse.SetPxPyPzE(electronsSelected.at(2).px, electronsSelected.at(2).py,
                                        0.0, sqrt(pow(electronsSelected.at(2).energy,2) - pow(electronsSelected.at(2).pz,2)));

        lep3NumTrackHits = electronsSelected.at(2).tkNumValidHits;
        lep3NumPixelHits = electronsSelected.at(2).numberOfValidPixelBarrelHits + electronsSelected.at(2).numberOfValidPixelEndcapHits;
        lep3NumberOfMatches = electronsSelected.at(2).numClusters;
        lep3Chi2 = electronsSelected.at(2).tkNormChi2;
        lep3NumExpectedHits = electronsSelected.at(2).numberOfExpectedInnerHits;
        ...
        lep2PassSSCut = ( (lep2TkCharge == lep2GsfCharge) && (fabs(lep2IP) < 0.02) &&
                          (fabs(lep1_correctedD0 - lep2_correctedD0) < 0.015) &&
                          (lep2dFracScEtTkPt < 1) );
        lep3PassSSCut = ( (lep3TkCharge == lep3GsfCharge) && (fabs(lep3IP) < 0.02) &&
                          (fabs(lep1_correctedD0 - lep3_correctedD0) < 0.015) &&
                          (lep3dFracScEtTkPt < 1) );
        ...
        if (isData) { lep1FlipSF = 1.0; lep2FlipSF = 1.0; lep3FlipSF = 1.0; lep1PromptSF = 1.0; lep2PromptSF = 1.0; lep3PromptSF = 1.0; }
          ...
          lep3FlipSF = 1.0 + (lep3GsfCharge == -1*lep3GenCharge && lep3PassSSCut) * ((0.979 - 1.0) + 316.0*pow(lep3Pt,-2));
	  ...
	  if( TwoMuonEle ){
        ...
        lep1SF = beanHelper.GetMuonSF(muonsSelected.at(0));
        lep2SF = beanHelper.GetMuonSF(muonsSelected.at(1));
        lep3SF = beanHelper.GetElectronSF(electronsSelected.at(0));

	    lep1Pt = muonsSelected.at(0).pt;
	    lep2Pt = muonsSelected.at(1).pt;
	    lep3Pt = electronsSelected.at(0).pt;
	    
	    lep1_et = muonsSelected.at(0).et;
	    lep2_et = muonsSelected.at(1).et;
	    lep3_et = electronsSelected.at(0).et;  

	    lep1Eta = muonsSelected.at(0).eta;
	    lep2Eta = muonsSelected.at(1).eta;
	    lep3Eta = electronsSelected.at(0).eta;  

	    lep1Phi = muonsSelected.at(0).phi;
	    lep2Phi = muonsSelected.at(1).phi;
	    lep3Phi = electronsSelected.at(0).phi;  

        lep1_tkDZ = muonsSelected.at(0).tkDZ;
        lep2_tkDZ = muonsSelected.at(1).tkDZ;
        lep3_tkDZ = electronsSelected.at(0).tkDZ;

        lep1_correctedDZ = muonsSelected.at(0).correctedDZ;
        lep2_correctedDZ = muonsSelected.at(1).correctedDZ;
        lep3_correctedDZ = electronsSelected.at(0).correctedDZ;

        lep1_correctedD0 = muonsSelected.at(0).correctedD0;
        lep2_correctedD0 = muonsSelected.at(1).correctedD0;
        lep3_correctedD0 = electronsSelected.at(0).correctedD0;
        
        lep1IP = muonsSelected.at(0).IP;
        lep2IP = muonsSelected.at(1).IP;
        lep3IP = electronsSelected.at(0).IP;

        lep1IPError = muonsSelected.at(0).IPError;
        lep2IPError = muonsSelected.at(1).IPError;
        lep3IPError = electronsSelected.at(0).IPError;

        lep3dFracScEtTkPt = fabs(electronsSelected.at(0).scEt - electronsSelected.at(0).tkPT)/electronsSelected.at(0).scEt;
        
        lep1TkCharge = muonsSelected.at(0).tkCharge;
        lep2TkCharge = muonsSelected.at(1).tkCharge;
        lep3TkCharge = electronsSelected.at(0).tkCharge;

        lep3GsfCharge = electronsSelected.at(0).gsfCharge;

        lep1GenID = muonsSelected.at(0).genId;
        lep2GenID = muonsSelected.at(1).genId;
        lep3GenID = electronsSelected.at(0).genId;

        lep1GenMotherID = muonsSelected.at(0).genMotherId;
        lep2GenMotherID = muonsSelected.at(1).genMotherId;
        lep3GenMotherID = electronsSelected.at(0).genMotherId;

        lep1GenCharge = muonsSelected.at(0).genCharge;
        lep2GenCharge = muonsSelected.at(1).genCharge;
        lep3GenCharge = electronsSelected.at(0).genCharge;
        ...
        if (lep3GenID == -99) {
          MCLep3 = beanHelper.GetMatchedMCparticle(mcparticles,electronsSelected.at(0),0.1);
          if (MCLep3.id != -99 && abs(MCLep3.id) != 6 && abs(MCLep3.id) != 23 && abs(MCLep3.id) != 24 && abs(MCLep3.id) != 25) {
            lep3GenID = MCLep3.id;
            lep3GenMotherID = MCLep3.motherId;
            lep3GenCharge = MCLep3.charge;
        ...
        if (selectionYearStr == "2011") {
          ...
          lep2Iso = (muonsSelected.at(1).chargedHadronIso
                      + muonsSelected.at(1).neutralHadronIso
                      + muonsSelected.at(1).photonIso) * 1.0 / lep2Pt;
          lep3Iso = (electronsSelected.at(0).chargedHadronIso + electronsSelected.at(0).neutralHadronIso + electronsSelected.at(0).photonIso) * 1.0 / lep3Pt;

          lep1ChargedIso = muonsSelected.at(0).chargedHadronIso / lep1Pt;
          lep2ChargedIso = muonsSelected.at(1).chargedHadronIso / lep2Pt;
          lep3ChargedIso = electronsSelected.at(0).chargedHadronIso / lep3Pt;
        }
        else if (selectionYearStr == "2012_52x" || selectionYearStr == "2012_53x") {
          lep1Iso = (muonsSelected.at(0).pfIsoR04SumChargedHadronPt
                      + max(0.0, muonsSelected.at(0).pfIsoR04SumNeutralHadronEt
          ...
          lep2Iso = (muonsSelected.at(1).pfIsoR04SumChargedHadronPt
                      + max(0.0, muonsSelected.at(1).pfIsoR04SumNeutralHadronEt
                                 + muonsSelected.at(1).pfIsoR04SumPhotonEt
                                 - 0.5*muonsSelected.at(1).pfIsoR04SumPUPt)) * 1.0 /lep2Pt;
          lep3Iso = ( electronsSelected.at(0).chargedHadronIso
                       + max(0.0, electronsSelected.at(0).neutralHadronIso
                                  + electronsSelected.at(0).photonIso
                                  - electronsSelected.at(0).AEffDr03*electronsSelected.at(0).rhoPrime) ) * 1.0 /lep3Pt;
          lep1ChargedIso = muonsSelected.at(0).pfIsoR04SumChargedHadronPt /lep1Pt;
          lep2ChargedIso = muonsSelected.at(1).pfIsoR04SumChargedHadronPt /lep2Pt;
          lep3ChargedIso = electronsSelected.at(0).chargedHadronIso / lep3Pt;
        }
	    ...
	    lep_vect1.SetPxPyPzE(muonsSelected.at(0).px, muonsSelected.at(0).py, muonsSelected.at(0).pz, muonsSelected.at(0).energy);
	    lep_vect2.SetPxPyPzE(muonsSelected.at(1).px, muonsSelected.at(1).py, muonsSelected.at(1).pz, muonsSelected.at(1).energy);
	    lep_vect3.SetPxPyPzE(electronsSelected.at(0).px, electronsSelected.at(0).py, electronsSelected.at(0).pz, electronsSelected.at(0).energy);
        lep_vect1_transverse.SetPxPyPzE(muonsSelected.at(0).px, muonsSelected.at(0).py,
                                        0.0, sqrt(pow(muonsSelected.at(0).energy,2) - pow(muonsSelected.at(0).pz,2)));
        lep_vect2_transverse.SetPxPyPzE(muonsSelected.at(1).px, muonsSelected.at(1).py,
                                        0.0, sqrt(pow(muonsSelected.at(1).energy,2) - pow(muonsSelected.at(1).pz,2)));
	    lep_vect3_transverse.SetPxPyPzE(electronsSelected.at(0).px, electronsSelected.at(0).py,
                                        0.0, sqrt(pow(electronsSelected.at(0).energy,2) - pow(electronsSelected.at(0).pz,2)));
	  ...
	  if( TwoEleMuon ){
        ...
        lep3SF = beanHelper.GetMuonSF(muonsSelected.at(0));
        lep1SF = beanHelper.GetElectronSF(electronsSelected.at(0));
        lep2SF = beanHelper.GetElectronSF(electronsSelected.at(1));

	    lep3Pt = muonsSelected.at(0).pt;
	    lep1Pt = electronsSelected.at(0).pt;
	    lep2Pt = electronsSelected.at(1).pt;
	    
	    lep3_et = muonsSelected.at(0).et;
	    lep1_et = electronsSelected.at(0).et;  
	    lep2_et = electronsSelected.at(1).et;  

	    lep3Eta = muonsSelected.at(0).eta;
	    lep1Eta = electronsSelected.at(0).eta;  
	    lep2Eta = electronsSelected.at(1).eta;  

	    lep3Phi = muonsSelected.at(0).phi;
	    lep1Phi = electronsSelected.at(0).phi;  
	    lep2Phi = electronsSelected.at(1).phi;  

        lep3_tkDZ = muonsSelected.at(0).tkDZ;
        lep1_tkDZ = electronsSelected.at(0).tkDZ;
        lep2_tkDZ = electronsSelected.at(1).tkDZ;

        lep3_correctedDZ = muonsSelected.at(0).correctedDZ;
        lep1_correctedDZ = electronsSelected.at(0).correctedDZ;
        lep2_correctedDZ = electronsSelected.at(1).correctedDZ;

        lep3_correctedD0 = muonsSelected.at(0).correctedD0;
        lep1_correctedD0 = electronsSelected.at(0).correctedD0;
        lep2_correctedD0 = electronsSelected.at(1).correctedD0;
        
        lep3IP = muonsSelected.at(0).IP;
        lep1IP = electronsSelected.at(0).IP;
        lep2IP = electronsSelected.at(1).IP;

        lep3IPError = muonsSelected.at(0).IPError;
        lep1IPError = electronsSelected.at(0).IPError;
        lep2IPError = electronsSelected.at(1).IPError;
        ...
        lep3TkCharge = muonsSelected.at(0).tkCharge;
        lep1TkCharge = electronsSelected.at(0).tkCharge;
        lep2TkCharge = electronsSelected.at(1).tkCharge;
        ...
        lep3GenID = muonsSelected.at(0).genId;
        lep1GenID = electronsSelected.at(0).genId;
        lep2GenID = electronsSelected.at(1).genId;

        lep3GenMotherID = muonsSelected.at(0).genMotherId;
        lep1GenMotherID = electronsSelected.at(0).genMotherId;
        lep2GenMotherID = electronsSelected.at(1).genMotherId;

        lep3GenCharge = muonsSelected.at(0).genCharge;
        lep1GenCharge = electronsSelected.at(0).genCharge;
        lep2GenCharge = electronsSelected.at(1).genCharge;

        if (lep3GenID == -99) {
          MCLep3 = beanHelper.GetMatchedMCparticle(mcparticles,muonsSelected.at(0),0.1);
          if (MCLep3.id != -99 && abs(MCLep3.id) != 6 && abs(MCLep3.id) != 23 && abs(MCLep3.id) != 24 && abs(MCLep3.id) != 25) {
            lep3GenID = MCLep3.id;
            lep3GenMotherID = MCLep3.motherId;
            lep3GenCharge = MCLep3.charge;
        ...
        if (selectionYearStr == "2011") {
          lep3Iso = (muonsSelected.at(0).chargedHadronIso
                      + muonsSelected.at(0).neutralHadronIso
                      + muonsSelected.at(0).photonIso) * 1.0 / lep3Pt;
          ...
          lep2Iso = (electronsSelected.at(1).chargedHadronIso + electronsSelected.at(1).neutralHadronIso + electronsSelected.at(1).photonIso) * 1.0 / lep2Pt;

          lep3ChargedIso = muonsSelected.at(0).chargedHadronIso / lep3Pt;
          lep1ChargedIso = electronsSelected.at(0).chargedHadronIso / lep1Pt;
          lep2ChargedIso = electronsSelected.at(1).chargedHadronIso / lep2Pt;
        }
        else if (selectionYearStr == "2012_52x" || selectionYearStr == "2012_53x") {
          lep3Iso = (muonsSelected.at(0).pfIsoR04SumChargedHadronPt
                      + max(0.0, muonsSelected.at(0).pfIsoR04SumNeutralHadronEt
                                 + muonsSelected.at(0).pfIsoR04SumPhotonEt
                                 - 0.5*muonsSelected.at(0).pfIsoR04SumPUPt)) * 1.0 /lep3Pt;
          lep1Iso = ( electronsSelected.at(0).chargedHadronIso
                       + max(0.0, electronsSelected.at(0).neutralHadronIso
                                  + electronsSelected.at(0).photonIso
                                  - electronsSelected.at(0).AEffDr03*electronsSelected.at(0).rhoPrime) ) * 1.0 /lep1Pt;
          lep2Iso = ( electronsSelected.at(1).chargedHadronIso
                       + max(0.0, electronsSelected.at(1).neutralHadronIso
                                  + electronsSelected.at(1).photonIso
                                  - electronsSelected.at(1).AEffDr03*electronsSelected.at(1).rhoPrime) ) * 1.0 /lep2Pt;
          lep3ChargedIso = muonsSelected.at(0).pfIsoR04SumChargedHadronPt /lep3Pt;
          lep1ChargedIso = electronsSelected.at(0).chargedHadronIso / lep1Pt;
          lep2ChargedIso = electronsSelected.at(1).chargedHadronIso / lep2Pt;
        }
        else {
	    ...
	    lep_vect3.SetPxPyPzE(electronsSelected.at(1).px, electronsSelected.at(1).py, electronsSelected.at(1).pz, electronsSelected.at(1).energy);
        lep_vect1_transverse.SetPxPyPzE(muonsSelected.at(0).px, muonsSelected.at(0).py,
                                        0.0, sqrt(pow(muonsSelected.at(0).energy,2) - pow(muonsSelected.at(0).pz,2)));
	    lep_vect2_transverse.SetPxPyPzE(electronsSelected.at(0).px, electronsSelected.at(0).py,
                                        0.0, sqrt(pow(electronsSelected.at(0).energy,2) - pow(electronsSelected.at(0).pz,2)));
	    lep_vect3_transverse.SetPxPyPzE(electronsSelected.at(1).px, electronsSelected.at(1).py,
                                        0.0, sqrt(pow(electronsSelected.at(1).energy,2) - pow(electronsSelected.at(1).pz,2)));

        lep3PassSSCut = muonsSelected.at(0).numberOfValidTrackerHitsInnerTrack > 7;
        lep1PassSSCut = ( (lep1TkCharge == lep1GsfCharge) && (fabs(lep1IP) < 0.02) &&
                          (fabs(lep1_correctedD0 - lep2_correctedD0) < 0.015) &&
                          (lep1dFracScEtTkPt < 1) );
        lep2PassSSCut = ( (lep2TkCharge == lep2GsfCharge) && (fabs(lep2IP) < 0.02) &&
        ...
        if (isData) { lep3FlipSF = 1.0; lep1FlipSF = 1.0; lep2FlipSF = 1.0; lep3PromptSF = 1.0; lep1PromptSF = 1.0; lep2PromptSF = 1.0; }
        else {
          lep3FlipSF = 1.0;
          lep1FlipSF = 1.0 + (lep1GsfCharge == -1*lep1GenCharge && lep1PassSSCut) * ((0.979 - 1.0) + 316.0*pow(lep1Pt,-2));
          lep2FlipSF = 1.0 + (lep2GsfCharge == -1*lep2GenCharge && lep2PassSSCut) * ((0.979 - 1.0) + 316.0*pow(lep2Pt,-2));
      ...
      if (debug_) cout << "Successfully filled event with "
                      << numTightMuons+numLooseMuons << " muons and "
                      << numTightElectrons+numLooseElectrons << " electrons" << endl;
      ...
      if ( (abs(lep3GenID/100)%10 == 5) || (abs(lep3GenID/1000)%10 == 5))      lep3GenID = 5*lep3GenID/abs(lep3GenID);
      else if ( (abs(lep3GenID/100)%10 == 4) || (abs(lep3GenID/1000)%10 == 4)) lep3GenID = 4*lep3GenID/abs(lep3GenID);
      else if ( (abs(lep3GenID/100)%10 == 3) || (abs(lep3GenID/1000)%10 == 3)) lep3GenID = 3*lep3GenID/abs(lep3GenID);
      else if ( (abs(lep3GenID/100)%10 == 2) || (abs(lep3GenID/1000)%10 == 2)) lep3GenID = 2*lep3GenID/abs(lep3GenID);
      else if ( (abs(lep3GenID/100)%10 == 1) || (abs(lep3GenID/1000)%10 == 1)) lep3GenID = 1*lep3GenID/abs(lep3GenID);
      ...
      if ( (abs(lep3GenMotherID/100)%10 == 5) || (abs(lep3GenMotherID/1000)%10 == 5))      lep3GenMotherID = 5*lep3GenMotherID/abs(lep3GenMotherID);
      else if ( (abs(lep3GenMotherID/100)%10 == 4) || (abs(lep3GenMotherID/1000)%10 == 4)) lep3GenMotherID = 4*lep3GenMotherID/abs(lep3GenMotherID);
      else if ( (abs(lep3GenMotherID/100)%10 == 3) || (abs(lep3GenMotherID/1000)%10 == 3)) lep3GenMotherID = 3*lep3GenMotherID/abs(lep3GenMotherID);
      else if ( (abs(lep3GenMotherID/100)%10 == 2) || (abs(lep3GenMotherID/1000)%10 == 2)) lep3GenMotherID = 2*lep3GenMotherID/abs(lep3GenMotherID);
      else if ( (abs(lep3GenMotherID/100)%10 == 1) || (abs(lep3GenMotherID/1000)%10 == 1)) lep3GenMotherID = 1*lep3GenMotherID/abs(lep3GenMotherID);
      
      float lepTotalSF = lep1SF * lep2SF * lep3SF;
      float lepTotalFlipSF = lep1FlipSF*lep2FlipSF*lep3FlipSF;
      float lepTotalPromptSF = lep1PromptSF*lep2PromptSF*lep3PromptSF;
      int lepTotalPassSSCut = 1 * (lep1PassSSCut == 1 && lep2PassSSCut == 1 && lep3PassSSCut == 1);
      
      
	  // two leptons
	  TLorentzVector two_lepton = lep_vect1 + lep_vect2;
	  TLorentzVector two_lepton_1 = lep_vect1 + lep_vect3;
	  TLorentzVector two_lepton_2 = lep_vect2 + lep_vect3;
      TLorentzVector met_lep1 = metV + lep_vect1_transverse;
      TLorentzVector met_lep2 = metV + lep_vect2_transverse;
      TLorentzVector met_lep3 = metV + lep_vect3_transverse;

      float mass_met_lep1_transverse = met_lep1.M();
      float mass_met_lep2_transverse = met_lep2.M();
      float mass_met_lep3_transverse = met_lep3.M();
      float dPhi_met_lep1 = lep_vect1.DeltaPhi(metV);
      float dPhi_met_lep2 = lep_vect2.DeltaPhi(metV);
      float dPhi_met_lep3 = lep_vect3.DeltaPhi(metV);
	  float mass_leplep = two_lepton.M();
	  float mass_leplep_1 = two_lepton_1.M();
	  float mass_leplep_2 = two_lepton_2.M();
	  float pt_leplep = two_lepton.Pt();
	  float pt_leplep_1 = two_lepton_1.Pt();
	  float pt_leplep_2 = two_lepton_2.Pt();
	  float dPhi_leplep = lep_vect1.DeltaPhi(lep_vect2);
	  float dPhi_leplep_1 = lep_vect1.DeltaPhi(lep_vect3);
	  float dPhi_leplep_2 = lep_vect2.DeltaPhi(lep_vect3);
	  float dR_leplep = lep_vect1.DeltaR(lep_vect2);
	  float dR_leplep_1 = lep_vect1.DeltaR(lep_vect3);
	  float dR_leplep_2 = lep_vect2.DeltaR(lep_vect3);
      float dEta_leplep = lep_vect1.Eta() - lep_vect2.Eta();
      float dEta_leplep_1 = lep_vect1.Eta() - lep_vect3.Eta();
      float dEta_leplep_2 = lep_vect2.Eta() - lep_vect3.Eta();
      float correctedDZ_leplep = lep1_correctedDZ - lep2_correctedDZ;
      float correctedDZ_leplep_1 = lep1_correctedDZ - lep3_correctedDZ;
      float correctedDZ_leplep_2 = lep2_correctedDZ - lep3_correctedDZ;
      float correctedD0_leplep = lep1_correctedD0 - lep2_correctedD0;
      float correctedD0_leplep_1 = lep1_correctedD0 - lep3_correctedD0;
      float correctedD0_leplep_2 = lep2_correctedD0 - lep3_correctedD0;
      float tkDZ_leplep = lep1_tkDZ - lep2_tkDZ;
      float tkDZ_leplep_1 = lep1_tkDZ - lep3_tkDZ;
      float tkDZ_leplep_2 = lep2_tkDZ - lep3_tkDZ;
      ...
      if(numTaggedJets>1){
        ...
        TLorentzVector ttbar_vect = metV + lep_vect1 + lep_vect2 + lep_vect3 + bjet1_vect + bjet2_vect;
      ...
      for (int i=0; i<numGoodAndBadJets; i++) {
	    ...
	    if (mindr_lep3_allJet > lep_vect3.DeltaR(allJet_vect) || mindr_lep3_allJet == dFloat){
	      mindr_lep3_allJet = lep_vect3.DeltaR(allJet_vect); 
          ptRel_lep3_allJet = lep_vect3.Pt() / (lep_vect3.Pt() + allJet_vect.Pt());
	    }
	  ...
	  for (int i=0; i < numGoodJets; i++) {
	    ...
	    if (mindr_lep3_jet > lep_vect3.DeltaR(jet_vect) || mindr_lep3_jet == dFloat){
	      mindr_lep3_jet = lep_vect3.DeltaR(jet_vect); 
          ptRel_lep3_jet = lep_vect3.Pt() / (lep_vect3.Pt() + jet_vect.Pt());
	    }
      ...
      bool PassBigDiamondZmask = ( (lep1GsfCharge == -lep2GsfCharge) &&
                                   ( (mass_leplep < (65.5 + 3*MHT/8)) || (mass_leplep > (108 - MHT/4))
                                     || (mass_leplep < (79 - 3*MHT/4)) || (mass_leplep > (99 + MHT/2)) ) );
      bool PassBigDiamondZmask2 = ( (lep1GsfCharge == -lep2GsfCharge) &&
                                    ( (mass_leplep < (65.5 + 3*met/8)) || (mass_leplep > (108 - met/4))
                                      || (mass_leplep < (79 - 3*met/4)) || (mass_leplep > (99 + met/2)) ) );
      bool PassBigDiamondZmask3 = ( (lep1GsfCharge == -lep2GsfCharge) &&
                                    ( (mass_leplep < (65.5 + 3*pt_of_leps_and_allJets/8)) || (mass_leplep > (108 - pt_of_leps_and_allJets/4))
                                      || (pt_of_leps_and_allJets < (79 - 3*pt_of_leps_and_allJets/4)) || (mass_leplep > (99 + pt_of_leps_and_allJets/2)) ) );
	...
	if( j < 5){
	  ...
	  *(floatBranches[branchName]) = annOut1;  
      ...
      if (debug_) cout << "About to fill branches" << endl;
      
      if (CoreVariables) {

        //event variables
        *(intBranches["PassThreeLepton"]) =  PassThreeLepton ? 1 : 0;
        *(intBranches["ThreeMuon"]) = ThreeMuon ? 1 : 0;
        *(intBranches["ThreeEle"]) =  ThreeEle ? 1 : 0;
        *(intBranches["TwoMuonEle"]) = TwoMuonEle ? 1 : 0;
        *(intBranches["TwoEleMuon"]) = TwoEleMuon ? 1 : 0;
        ...
        *(floatBranches["mass_leplep_1"]) = mass_leplep_1;
        *(floatBranches["mass_leplep_2"]) = mass_leplep_2;
        *(floatBranches["pt_leplep"]) = pt_leplep;
        *(floatBranches["pt_leplep_1"]) = pt_leplep_1;
        *(floatBranches["pt_leplep_2"]) = pt_leplep_2;
        *(floatBranches["dPhi_leplep"]) = dPhi_leplep;
        *(floatBranches["dPhi_leplep_1"]) = dPhi_leplep_1;
        *(floatBranches["dPhi_leplep_2"]) = dPhi_leplep_2;
        *(floatBranches["dR_leplep"]) = dR_leplep;
        *(floatBranches["dR_leplep_1"]) = dR_leplep_1;
        *(floatBranches["dR_leplep_2"]) = dR_leplep_2;
        *(floatBranches["correctedDZ_leplep"]) = correctedDZ_leplep;
        *(floatBranches["correctedDZ_leplep_1"]) = correctedDZ_leplep_1;
        *(floatBranches["correctedDZ_leplep_2"]) = correctedDZ_leplep_2;
        *(floatBranches["correctedD0_leplep"]) = correctedD0_leplep;
        *(floatBranches["correctedD0_leplep_1"]) = correctedD0_leplep_1;
        *(floatBranches["correctedD0_leplep_2"]) = correctedD0_leplep_2;
        *(floatBranches["tkDZ_leplep"]) = tkDZ_leplep;
        *(floatBranches["tkDZ_leplep_1"]) = tkDZ_leplep_1;
        *(floatBranches["tkDZ_leplep_2"]) = tkDZ_leplep_2;
      ...
      if (ExtraSameSignVariables) {
        ...
        *(floatBranches["lep3FlipSF"]) = lep3FlipSF;
        ...
        *(floatBranches["lep3PromptSF"]) = lep3PromptSF;
        ...
        *(intBranches["lep3PassSSCut"]) = lep3PassSSCut;
...
//         *(floatBranches["min_dr_genB2_allJet"]) = min_dr_genB2_allJet;
      ...
      if (ExtraLeptonVariables) {
        *(intBranches["lep3NumTrackHits"]) = lep3NumTrackHits;
        *(intBranches["lep3NumPixelHits"]) = lep3NumPixelHits;
        *(intBranches["lep3NumberOfMatches"]) = lep3NumberOfMatches;
        *(floatBranches["lep3Chi2"]) = lep3Chi2;
        *(intBranches["lep3NumExpectedHits"]) = lep3NumExpectedHits;
