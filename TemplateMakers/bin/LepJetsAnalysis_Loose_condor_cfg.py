...
#	sampleName = cms.string("ttbar"),
	eleSel = cms.bool(False), #If no skim was applied 
	muonSel  = cms.bool(False), #If no skim was applied TightMu and LooseLepVetos
	jetSel = cms.bool(False),  #If skim was not applied to >=3jets
