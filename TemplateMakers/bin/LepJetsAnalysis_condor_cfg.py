...
outDir = "batchBEAN/%s_%s%s%s%s/" % (sampleNameCL, iLabel, JesName, JerName, BsysName)
outFileName = "batchBEAN/%s_%s%s%s%s/lepJetsTemplateTrees_%s_%s_job%03d.root" % (sampleNameCL, iLabel, JesName, JerName, BsysName, sampleNameCL, iLabel, iJob)
## if iJes == 0:
##     if iJer == 0:
