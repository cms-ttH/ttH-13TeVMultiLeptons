...
public:
  ...
  LepCuts(collectionType **_selCollection,
...
template <class collectionType>
LepCuts<collectionType>::LepCuts(collectionType **_selCollection,
                                 string _branch_name, int _maxLeptons):
...
//         if ( ptr((*selCollection)->at(iObj))->jetBTagCSV > 0.679 ) {
//           branches[branchName].branchVal = -1; }
//         else if ( ptr((*selCollection)->at(iObj))->chargedHadronIsoDR04 < 0 || // < -1 does nothing; < 0 eliminates some
//                   ptr((*selCollection)->at(iObj))->chargedHadronIsoDR04 / ptr((*selCollection)->at(iObj))->pt > 0.15 ) {
//           branches[branchName].branchVal = 0; }
//         else if ( abs(ptr((*selCollection)->at(iObj))->IP) > 0.015 ||
//                   ptr((*selCollection)->at(iObj))->chargedHadronIsoDR04 / ptr((*selCollection)->at(iObj))->pt > 0.05 ||
//                   ptr((*selCollection)->at(iObj))->jetPtRatio < 0.6 ) {
//           branches[branchName].branchVal = 1; }
//         else branches[branchName].branchVal = 2;
...
//         if ( ptr((*selCollection)->at(iObj))->jetBTagCSV > 0.679 ) {
//           branches[branchName].branchVal = -1; }
//         else if ( abs(ptr((*selCollection)->at(iObj))->SIP) > 4 || 
//                  ptr((*selCollection)->at(iObj))->chargedHadronIsoDR04 / ptr((*selCollection)->at(iObj))->pt > 0.20 ) {
//           branches[branchName].branchVal = 0; }
//         else if ( ptr((*selCollection)->at(iObj))->chargedHadronIsoDR04 / ptr((*selCollection)->at(iObj))->pt > 0.10 ||
//                   ptr((*selCollection)->at(iObj))->jetPtRatio < 0.6 ) {
//           branches[branchName].branchVal = 1; }
//         else branches[branchName].branchVal = 2;
