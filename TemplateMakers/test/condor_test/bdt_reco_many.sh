...
#samples=( ["tth_aMC_old"]=213 )
samples=( ["tth_aMC_old"]=300 ["ttbar_semiLep_powheg"]=3 )
#samples=( ["tth_aMC_old"]=213 ["ttbar_semiLep_powheg"]=3 ["ttbar_diLep_powheg_tranche3"]=3 ["ttW_aMCatNLO"]=7 ["ttZ_aMCatNLO"]=3 ["tttt"]=20 ["tqZ"]=6 ["WW_diboson"]=1 ["ZZ_diboson"]=1 ["WZ_diboson"]=1 ["WWqq_rares"]=1 ["WW_doublescatering_rares"]=1 ["WWZ_rares"]=1 ["WZZ_rares"]=1 ["ZZZ_rares"]=1 ) 
