...
TChain* loadFiles(TString sample, int start_file =0, int end_file=-1)
{
  ...
  if (sample == "ttH-aMC@NLO")
    {
      TString base_dir = pre_fix + "/store/user/muell149/ttH-leptons_Skims/80X_nTuples_reHLT_v2/ttHJetToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8_mWCutfix/crab_ttH125_aMC/160720_083339/0000/tree_test__";
      if (end_file == -1 || end_file == 0) end_file = 201; //78 input files
