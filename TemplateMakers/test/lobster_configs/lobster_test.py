...
## in a pinch could try one of these:
#/TTJets_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIFall17MiniAOD-94X_mc2017_realistic_v11-v1/MINIAODSIM
...
#### 2017 ####
mysamples.append(['SingleElectron_Run2017B','/SingleElectron/Run2017B-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleElectron_Run2017C','/SingleElectron/Run2017C-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleElectron_Run2017D','/SingleElectron/Run2017D-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleElectron_Run2017E','/SingleElectron/Run2017E-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleElectron_Run2017F','/SingleElectron/Run2017F-17Nov2017-v1/MINIAOD'])

mysamples.append(['SingleMuon_Run2017B','/SingleMuon/Run2017B-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleMuon_Run2017C','/SingleMuon/Run2017C-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleMuon_Run2017D','/SingleMuon/Run2017D-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleMuon_Run2017E','/SingleMuon/Run2017E-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleMuon_Run2017F','/SingleMuon/Run2017F-17Nov2017-v1/MINIAOD'])
mysamples.append(['SingleMuon_Run2017H','/SingleMuon/Run2017H-17Nov2017-v1/MINIAOD'])

mysamples.append(['DoubleEG_Run2017B','/DoubleEG/Run2017B-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleEG_Run2017C','/DoubleEG/Run2017C-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleEG_Run2017D','/DoubleEG/Run2017D-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleEG_Run2017E','/DoubleEG/Run2017E-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleEG_Run2017F','/DoubleEG/Run2017F-17Nov2017-v1/MINIAOD'])

mysamples.append(['DoubleMuon_Run2017B','/DoubleMuon/Run2017B-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleMuon_Run2017C','/DoubleMuon/Run2017C-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleMuon_Run2017D','/DoubleMuon/Run2017D-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleMuon_Run2017E','/DoubleMuon/Run2017E-17Nov2017-v1/MINIAOD'])
mysamples.append(['DoubleMuon_Run2017F','/DoubleMuon/Run2017F-17Nov2017-v1/MINIAOD'])

mysamples.append(['MuonEG_Run2017B','/MuonEG/Run2017B-17Nov2017-v1/MINIAOD'])
mysamples.append(['MuonEG_Run2017C','/MuonEG/Run2017C-17Nov2017-v1/MINIAOD'])
mysamples.append(['MuonEG_Run2017D','/MuonEG/Run2017D-17Nov2017-v1/MINIAOD'])
mysamples.append(['MuonEG_Run2017E','/MuonEG/Run2017E-17Nov2017-v1/MINIAOD'])
mysamples.append(['MuonEG_Run2017F','/MuonEG/Run2017F-17Nov2017-v1/MINIAOD'])
