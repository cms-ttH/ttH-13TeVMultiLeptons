...
public:
 PlotObject(TString hist_name_="name", TString hist_title_="hist_title", int bins_=10, double xmin_=0., double xmax_ =100., TString drawCommand_="mcwgt"):
  ...
  void fill(Sample sample, TFile* fout=0)
  {
    ...
    //    TH1D* template_hist = new TH1D(template_name,hist_title,bins,xmin,xmax);
    ...
    TH1D* ee_hist = (TH1D*)template_hist->Clone(ee_name);    
    TH1D* em_hist = (TH1D*)template_hist->Clone(em_name);    
    TH1D* mm_hist = (TH1D*)template_hist->Clone(mm_name);    
    ...
    template_hist_ = (TH1D*)template_hist->Clone();
    /* ee_hist_ = ee_hist; */
    /* mm_hist_ = mm_hist; */
    /* em_hist_ = em_hist; */
...
public:
 StackObject(TString stack_name_="name", TString stack_title_="stack_title"):
  ...
  {
    template_stack->Add(plot.template_hist_);
