...
//                         numgen[4]=2514003.0102;
		...
		if (samps[i]==5)
		{
                        ...
                        for (int sampvectit=0; sampvectit<dummy.size(); sampvectit++) ch[5]->Add(dummy[sampvectit].c_str());                        
		...
		if (samps[i]==8)
		{
                        ...
                        for (int sampvectit=0; sampvectit<dummy.size(); sampvectit++) ch[8]->Add(dummy[sampvectit].c_str());
			//xsecs[8]=0.6647;
                        xsecs[8]=1.152; // our twiki
                        numgen[8]=246521.0;
		}
		if (samps[i]==9)
		{
...
//                 if (samps[i]==12)
// 		{
// 			std::vector<std::string> dummy = TTbarH_M-125_13TeV_amcatnlo_pythia8_tauola();
