...
double loadsample(const int samp, TChain &ch)
{
    ...
    TString basedir = "/store/ndpc5disk2/gesmith/crab/crab_trigSF2017_test_28_11_17/";     // The directory on ndpc disk where your samples are located.
    ...
    else if (samp==20) // MET_2017A
    {
	    TString basedir_plus = "MET_2017A_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";
            ch.Add(thesample);
	    basedir_plus = "MET_2017A_PRv2/";
	    thesample = basedir + basedir_plus + "*.root";  
            ch.Add(thesample);
	    basedir_plus = "MET_2017A_PRv3/";
	    thesample = basedir + basedir_plus + "*.root";                      
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
    }    
    else if (samp==21) // MET_2017B
    {
	    TString basedir_plus = "MET_2017B_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";
            ch.Add(thesample);
	    basedir_plus = "MET_2017B_PRv2/";
	    thesample = basedir + basedir_plus + "*.root";                     
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
    } 
    else if (samp==22) // MET_2017C
    {
	    TString basedir_plus = "MET_2017C_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";
            ch.Add(thesample);
	    basedir_plus = "MET_2017C_PRv2/";
	    thesample = basedir + basedir_plus + "*.root";  
            ch.Add(thesample);
//	    basedir_plus = "MET_2017C_PRv3/";
//	    thesample = basedir + basedir_plus + "*.root";                      
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
    } 
    else if (samp==23) // MET_2017D
    {
	    TString basedir_plus = "MET_2017D_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";                
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
    } 
    else if (samp==24) // MET_2017E
    {
	    TString basedir_plus = "MET_2017E_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";                   
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
    } 
    else if (samp==25) // MET_2017F
    {
	    TString basedir_plus = "MET_2017F_PRv1/";
	    TString thesample = basedir + basedir_plus + "*.root";                   
	    ch.Add(thesample);
	    xsec=-999.; // (data)
            numgen = -999; // (data)
