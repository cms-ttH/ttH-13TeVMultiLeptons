...
//         canvas.Add(can12);
        ...
        can13->addPlot(*this,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt",i,"Prompt");
        can13->addPlot(*this,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt",i,"Non-prompt");
        ...
        // GoodPlot *jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt = new GoodPlot("jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt"+sample_names_reg[samples[i]]);
//         jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt->addPlot2D(*this,i,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt");
//         canvas.Add(jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt);
//         GoodPlot *jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt = new GoodPlot("jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt"+sample_names_reg[samples[i]]);
//         jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt->addPlot2D(*this,i,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt");
//         canvas.Add(jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt);
//         GoodPlot *jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt = new GoodPlot("jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt"+sample_names_reg[samples[i]]);
//         jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt->addPlot2D(*this,i,"jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt");
//         canvas.Add(jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt);
//         GoodPlot *jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt = new GoodPlot("jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt"+sample_names_reg[samples[i]]);
//         jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt->addPlot2D(*this,i,"jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt");
//         canvas.Add(jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt);
        
        // using new helper function:
        makeAndAdd2DPlot1Sample(*this,i,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_prompt_vs_lep_pt");
        makeAndAdd2DPlot1Sample(*this,i,"jet_pt_minus_electron_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt");
        makeAndAdd2DPlot1Sample(*this,i,"jet_pt_minus_muon_pt_one_jet_in_dR0p4_prompt_vs_lep_pt");
        makeAndAdd2DPlot1Sample(*this,i,"jet_pt_minus_muon_pt_one_jet_in_dR0p4_nonprompt_vs_lep_pt");
    }
}      
