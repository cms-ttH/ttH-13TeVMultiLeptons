void PlotHelper::trigger_studies()
{
    bool debug = false;		
...
//            if (j>100000) break;
//             tightMvaBased_leptons_intree = preselected_leptons_intree;
//             tightMvaBased_electrons_intree = preselected_electrons_intree;
//             tightMvaBased_muons_intree = preselected_muons_intree;
            ...
            if (passes_common())
            {
                if ((*tightMvaBased_leptons_intree)[0].obj.Eta()>maxeta) maxeta = (*tightMvaBased_leptons_intree)[0].obj.Eta();
                
                // ee
                if (passes_SSee())
                {
                    if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25. && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15. && passedMET_OR)
                    {
                ...
                if (passes_SSmumu())
                {
                    if ((*tightMvaBased_muons_intree)[0].obj.Pt()>20. && (*tightMvaBased_muons_intree)[1].obj.Pt()>10. && passedMET_OR)
                    {
                ...
                if ( passes_SSemu())
                {
                    ...
                    //if ((*tightMvaBased_leptons_intree)[0].obj.Pt()>20. && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15. && (*tightMvaBased_muons_intree)[0].obj.Pt()>10.)
                    if ((*tightMvaBased_leptons_intree)[0].obj.Pt()>25. && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15. && (*tightMvaBased_muons_intree)[0].obj.Pt()>10. && passedMET_OR)
                    {
                        passSSemu_2l_denom = true;
                    }
                    
//                     if ( (*tightMvaBased_electrons_intree)[0].obj.Pt() > (*tightMvaBased_muons_intree)[0].obj.Pt() )
//                     {
...
//                     else
//                     {                        
//                         if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>15. && (*tightMvaBased_muons_intree)[0].obj.Pt()>20.)
//                         {
//                         
//                             passSSemu_2l_denom = true;
//                         
...
//                     }
                ...
                if (passes_3l())
                {
                    ...
                    if ((*tightMvaBased_electrons_intree).size()==3)
                    {
                        if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[2].obj.Pt()>15) pass3leee_denom = true;                       
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[2].obj.Pt()>10) pass3leee_1l_denom = true;                       
                        
                    }
                    if ((*tightMvaBased_muons_intree).size()==3)
                    {
                        if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15 && (*tightMvaBased_muons_intree)[2].obj.Pt()>15) pass3lmumumu_denom = true;
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10 && (*tightMvaBased_muons_intree)[2].obj.Pt()>10) pass3lmumumu_1l_denom = true;

                    }
                    if ((*tightMvaBased_muons_intree).size()==2 && (*tightMvaBased_electrons_intree).size()==1)
                    {
                        
                        if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15) pass3lmumue_denom = true;
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15) pass3lmuemu_denom = true;
                        if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>15 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15) pass3lemumu_denom = true;

                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10) pass3lmumue_1l_denom = true;
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) pass3lmuemu_1l_denom = true;
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) pass3lemumu_1l_denom = true;
                       
                    }
                    if ((*tightMvaBased_muons_intree).size()==1 && (*tightMvaBased_electrons_intree).size()==2)
                    {
                        
                        if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15 && (*tightMvaBased_muons_intree)[0].obj.Pt()>15) pass3leemu_denom = true;
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15) pass3lemue_denom = true;
                        if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15) pass3lmuee_denom = true;                        

                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10) pass3leemu_1l_denom = true;
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10) pass3lemue_1l_denom = true;
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10) pass3lmuee_1l_denom = true;                        
                ...
                for (int k=0; k<numtrigfire; k++)
                {
                    ...
                    {
                        std::size_t found1 = (*passTrigger_intree)[k].find("HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v_leaveout");
                        std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v"); // yes
                    ...
                    if (passSSee_2l_denom)
                    {
                        ...
                        std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Ele27_WPTight_Gsf_v");          // new
                        std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Ele25_eta2p1_WPTight_Gsf_v");   // new
                        std::size_t found4 = (*passTrigger_intree)[k].find("HLT_Ele27_eta2p1_WPLoose_Gsf_v");   // only one from before                                                
                    ...
                    if (passSSmumu_2l_denom)
                    {
                        ...
                        std::size_t found1 = (*passTrigger_intree)[k].find("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v"); // yes
                        std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v"); // yes
                        if (found1!=std::string::npos || found2!=std::string::npos)
                        {
                            passSSmumu_2l = true;
                        }
                    ...
                    if (passSSemu_2l_denom)
                    {
                        ...
                        std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v"); // new
                    ...
                    if (passSSemu_2l_denom)
                    {
                        ...
                        std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_v"); // new
                    ...
                    if (pass3leee_denom)
                    {
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>20 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[2].obj.Pt()>10)  
                        //{
                            
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_Ele16_Ele12_Ele8_CaloIdL_TrackIdL_v"); // yes
                            std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v_leaveout");
                            std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v"); // yes
                        ...
                        //}                
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[2].obj.Pt()>10)
                        //{

                            found1 = (*passTrigger_intree)[k].find("dummy");                        
                            found2 = (*passTrigger_intree)[k].find("HLT_Ele27_WPTight_Gsf_v");          // new
                            found3 = (*passTrigger_intree)[k].find("HLT_Ele25_eta2p1_WPTight_Gsf_v");   // new
                            std::size_t found4 = (*passTrigger_intree)[k].find("HLT_Ele27_eta2p1_WPLoose_Gsf_v");   // only one from before
                    ...
                    {                    
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>20 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15 && (*tightMvaBased_muons_intree)[2].obj.Pt()>10)  
                        //{
                                                    
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_TripleMu_5_3_3_v_leaveout");
                            std::size_t found2 = (*passTrigger_intree)[k].find("HLT_TripleMu_12_10_5_v");               // yes
                            std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v"); // yes
                            std::size_t found4 = (*passTrigger_intree)[k].find("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v"); // yes
                            if (found1!=std::string::npos || found2!=std::string::npos || found3!=std::string::npos || found4!=std::string::npos)
                            {
                                pass3lmumumu = true;
                            }                                             
                        //}                
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10 && (*tightMvaBased_muons_intree)[2].obj.Pt()>10)
                        //{
                            
                            found1 = (*passTrigger_intree)[k].find("HLT_IsoMu22_v"); // old
                            found2 = (*passTrigger_intree)[k].find("HLT_IsoTkMu22_v"); // old  
                            found3 = (*passTrigger_intree)[k].find("HLT_IsoMu22_eta2p1_v"); // new
                            found4 = (*passTrigger_intree)[k].find("HLT_IsoTkMu22_eta2p1_v"); // new
                            std::size_t found5 = (*passTrigger_intree)[k].find("HLT_IsoMu24_v"); // new
                            std::size_t found6 = (*passTrigger_intree)[k].find("HLT_IsoTkMu24_v"); // new
                    ...
                    {
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>20 && (*tightMvaBased_muons_intree)[1].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10) 
                        //{
                            
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_DiMu9_Ele9_CaloIdL_TrackIdL_v"); // yes
                        ...
                        //}                    
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10) 
                        //{
                            found1 = (*passTrigger_intree)[k].find("HLT_IsoMu22_v"); // old
                            found2 = (*passTrigger_intree)[k].find("HLT_IsoTkMu22_v"); // old  
                            found3 = (*passTrigger_intree)[k].find("HLT_IsoMu22_eta2p1_v"); // new
                    ...
                    {
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>20 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) 
                        //{
                            
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_DiMu9_Ele9_CaloIdL_TrackIdL_v"); // yes
                            std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_v"); // old
                            std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_v"); // new
                            std::size_t found4 = (*passTrigger_intree)[k].find("HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v"); // yes
                        ...
                        //}
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) 
                        //{
                    ...
                    {
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>20 && (*tightMvaBased_muons_intree)[0].obj.Pt()>15 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) 
                        //{
                            
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_DiMu9_Ele9_CaloIdL_TrackIdL_v"); // yes
                            std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v"); // old
                            std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v"); // new
                        ...
                        //}
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10 && (*tightMvaBased_muons_intree)[1].obj.Pt()>10) 
                        //{                            
                    ...
                    if (pass3leemu_denom)
                    {
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>20 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>15 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10)
                        //{                            
                            std::size_t found1 = (*passTrigger_intree)[k].find("HLT_Mu8_DiEle12_CaloIdL_TrackIdL_v"); // yes
                            std::size_t found2 = (*passTrigger_intree)[k].find("HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v_leaveout");
                            std::size_t found3 = (*passTrigger_intree)[k].find("HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v"); // yes
                        ...
                        //}
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10)
                        //{
                            found1 = (*passTrigger_intree)[k].find("dummy");                        
                            found2 = (*passTrigger_intree)[k].find("HLT_Ele27_WPTight_Gsf_v");          // new
                            found3 = (*passTrigger_intree)[k].find("HLT_Ele25_eta2p1_WPTight_Gsf_v");   // new
                    ...
                    if (pass3lemue_denom)
                    {
                        ...
                        //}
                        //if ((*tightMvaBased_electrons_intree)[0].obj.Pt()>25 && (*tightMvaBased_muons_intree)[0].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10)
                        //{
                            found1 = (*passTrigger_intree)[k].find("dummy");                        
                            found2 = (*passTrigger_intree)[k].find("HLT_Ele27_WPTight_Gsf_v");          // new
                            found3 = (*passTrigger_intree)[k].find("HLT_Ele25_eta2p1_WPTight_Gsf_v");   // new
                    ...
                    if (pass3lmuee_denom)
                    {
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>20 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>15 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10)          
                        //{
                        ...
                        //}
                        //if ((*tightMvaBased_muons_intree)[0].obj.Pt()>25 && (*tightMvaBased_electrons_intree)[0].obj.Pt()>10 && (*tightMvaBased_electrons_intree)[1].obj.Pt()>10)                        
                        //{                             
                            found1 = (*passTrigger_intree)[k].find("HLT_IsoMu22_v"); // old
                            found2 = (*passTrigger_intree)[k].find("HLT_IsoTkMu22_v"); // old  
                            found3 = (*passTrigger_intree)[k].find("HLT_IsoMu22_eta2p1_v"); // new
...
//             if (passSSmumu_1l) count_passSSmumu_1l += weight;
            ...
            if (passSSee_2l_denom) 
            {
                //SSee2DPt_denom[samp_int]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSeePt_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSeePt_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSee2DEta_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSeeEta_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSeeEta_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
            ...
            if (passSSemu_2l_denom) 
            {
                //SSeu2DPt_denom"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSeuPt_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSeuPt_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSeu2DEta_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSeuEta_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSeuEta_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
            ...
            {
                //SSue2DPt_denom"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSuePt_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSuePt_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSue2DEta_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSueEta_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSueEta_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
                
            }    
            if (passSSmumu_2l_denom)             
            {
                //SSuu2DPt_denom"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );  
                th1d["SSuuPt_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSuuPt_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSuu2DEta_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );  
                th1d["SSuuEta_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSuuEta_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
                
                th1d["SSuu_total_denom"]->Fill(0.,weight);
            }             
            if (passSSee_2l)      
            {
                //SSee2DPt_numer"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSeePt_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSeePt_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSee2DEta_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSeeEta_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSeeEta_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
            ...
            if (passSSemu_2l)             
            {
                //SSeu2DPt_numer"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSeuPt_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSeuPt_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSeu2DEta_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSeuEta_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSeuEta_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
            ...
            {
                //SSue2DPt_numer"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSuePt_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSuePt_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSue2DEta_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSueEta_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSueEta_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
                
            }    
            if (passSSmumu_2l)             
            {
                //SSuu2DPt_numer"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SSuuPt_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SSuuPt_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SSuu2DEta_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SSuuEta_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SSuuEta_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
            ...
            if (pass3l_denom) 
            {
                //SS3l2DPt_denom"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SS3lPt_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SS3lPt_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SS3l2DEta_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SS3lEta_lep1_denom"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SS3lEta_lep2_denom"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
                
                th1d["SS3l_total_denom"]->Fill(0.,weight);
            }
            if (pass3l) 
            {
                //SS3l2DPt_numer"]->Fill( min((*tightMvaBased_leptons_intree)[0].obj.Pt(),99.9), min((*tightMvaBased_leptons_intree)[1].obj.Pt(),99.9), weight );
                th1d["SS3lPt_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Pt(), weight);
                th1d["SS3lPt_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Pt(), weight);
                
                //SS3l2DEta_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight );
                th1d["SS3lEta_lep1_numer"]->Fill( (*tightMvaBased_leptons_intree)[0].obj.Eta(), weight);
                th1d["SS3lEta_lep2_numer"]->Fill( (*tightMvaBased_leptons_intree)[1].obj.Eta(), weight);
