if __name__ == '__main__':
    ...
    jobID = 'trigSF2017_test_28_11_17'
    ...
    ## MET PDs for trigger SF calculation
    config.General.requestName = jobID+'__MET_2017A_PRv1'
    config.Data.inputDataset = '/MET/Run2017A-PromptReco-v1/MINIAOD'
    submit(config) 
    
    config.General.requestName = jobID+'__MET_2017A_PRv2'
    config.Data.inputDataset = '/MET/Run2017A-PromptReco-v2/MINIAOD'
    submit(config) 
    
    config.General.requestName = jobID+'__MET_2017A_PRv3'
    config.Data.inputDataset = '/MET/Run2017A-PromptReco-v3/MINIAOD'
    submit(config)     
    
    config.General.requestName = jobID+'__MET_2017B_PRv1'
    config.Data.inputDataset = '/MET/Run2017B-PromptReco-v1/MINIAOD'
    submit(config)     

    config.General.requestName = jobID+'__MET_2017B_PRv2'
    config.Data.inputDataset = '/MET/Run2017B-PromptReco-v2/MINIAOD'
    submit(config)     

    config.General.requestName = jobID+'__MET_2017C_PRv1'
    config.Data.inputDataset = '/MET/Run2017C-PromptReco-v1/MINIAOD'
    submit(config) 
    
    config.General.requestName = jobID+'__MET_2017C_PRv2'
    config.Data.inputDataset = '/MET/Run2017C-PromptReco-v2/MINIAOD'
    submit(config)     
    
    config.General.requestName = jobID+'__MET_2017C_PRv3'
    config.Data.inputDataset = '/MET/Run2017C-PromptReco-v3/MINIAOD'
    submit(config)     
    
    config.General.requestName = jobID+'__MET_2017D_PRv1'
    config.Data.inputDataset = '/MET/Run2017D-PromptReco-v1/MINIAOD'
    submit(config)     
    
    config.General.requestName = jobID+'__MET_2017E_PRv1'
    config.Data.inputDataset = '/MET/Run2017E-PromptReco-v1/MINIAOD'
    submit(config)       
    
    config.General.requestName = jobID+'__MET_2017F_PRv1'
    config.Data.inputDataset = '/MET/Run2017F-PromptReco-v1/MINIAOD'
    submit(config)    
