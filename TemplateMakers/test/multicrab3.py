if __name__ == '__main__':
    ...
    config.General.workArea = 'jetRecovery_v0p1'
    config.General.transferLogs=True
    config.JobType.pluginName = 'Analysis'
    config.JobType.psetName = 'osTwoLep_cfg.py'
    config.Data.splitting = 'EventAwareLumiBased' #LumiBased
    config.Data.outLFNDirBase = '/store/user/muell149/ttH-leptons_Skims/jetRecovery_v0p1'
...
#    config.Site.whitelist = ['T2_CH_CERN'] # ['T1_DE_KIT', 'T2_FR_CCIN2P3']
    ...
    config.Data.inputDataset = '/TTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8/RunIIFall15MiniAODv2-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/MINIAODSIM'
    config.Data.unitsPerJob = 50000
    submit(config)
