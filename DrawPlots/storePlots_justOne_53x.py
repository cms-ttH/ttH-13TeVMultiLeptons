...
#        drawStackPlot("CFMlpANN_e3je2t_53x", pg,  "ANN output", 10, 0.2, 0.86, lepselection, year, "root")
        drawStackPlot("CFMlpANN_e3je2t_v1", pg,  "ANN output", 10, 0.1, 0.9, lepselection, year, "root")
    elif ( jetselection == "ge4jeq2t" ):
#        drawStackPlot("CFMlpANN_ge4je2t_53x", pg,  "ANN output", 10, 0.04, 0.94, lepselection, year, "root")
...
###        drawStackPlot("CFMlpANN_ge3t_oldvar", pg, "ANN output", 10, 0.04, 0.84, lepselection, year, "root")
#        drawStackPlot("CFMlpANN_ge3t_53x", pg, "ANN output", 10, 0.04, 0.84, lepselection, year, "root")
