...
#		drawStackPlot("first_jet_pt", pg, "highest jet p_{T}", 20, 30, 330, lepselection,year, "draw")
	...
	if (jetselection == "eq2jeq2t"):
		...
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)",10, 200, 1100, lepselection,year, "draw")
		drawStackPlot("first_jet_pt", pg, "highest jet p_{T}", 10, 30, 330, lepselection,year, "draw")
