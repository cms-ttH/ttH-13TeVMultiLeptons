...
##	  defaultPlotGroup.lumi = myLumi*1e6
	...
	if (jetselection == "eq2jeq2t"):
		drawStackPlot("CFMlpANN_e2je2t", pg,  "ANN output", 10, 0.498, 0.503, lepselection,year, "draw")
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)", numBins*4/5, 200, 1000, lepselection,year, "draw")
	if (jetselection == "eq3jeq2t"):
		drawStackPlot("CFMlpANN_e3je2t", pg,  "ANN output", 10, 0.33, 0.73, lepselection, year, "draw")    
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)", numBins*7/5, 200, 1600, lepselection,year, "draw")
	if (jetselection == "ge4jeq2t"):
		drawStackPlot("CFMlpANN_ge4je2t", pg,  "ANN output", 10, 0.26, 0.66, lepselection, year, "draw")
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)", numBins*8/5, 200, 2000, lepselection,year, "draw")
	...
	if (jetselection == "ge1t"):
		drawStackPlot("numJets", pg,  "number of jets", 6, 2, 8, lepselection, year, "draw")
		drawStackPlot("numTaggedJets", pg,  "number of b-tagged jets", 4, 1, 5, lepselection, year, "draw")
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)", numBins*8/5, 100, 1700, lepselection,year, "draw")
	if (jetselection == "eq1t"):
		drawStackPlot("numJets", pg,  "number of jets", 6, 2, 8, lepselection, year, "draw")
		drawStackPlot("Ht", pg, "sum p_{T} (leptons,jets,MHT)", numBins*8/5, 100, 1700, lepselection,year, "draw")
...
# 	if (jetselection == "eq2jeq2t"):
# 		drawStackPlot("CFMlpANN_e2je2t", pg,  "ANN output 2 jet 2 tag", 10, 0.4975, 0.5035, lepselection, year, "draw")
# 	if (jetselection == "eq3jeq2t"):
# 		drawStackPlot("CFMlpANN_e3je2t", pg,  "ANN output 3 jet 2 tag", 10, 0.33, 0.73, lepselection, year, "draw")
# 	if (jetselection == "ge4jeq2t"):
# 		drawStackPlot("CFMlpANN_ge4je2t", pg,  "ANN output >=4 jet 2 tag", 10, 0.26, 0.66, lepselection, year, "draw")
# 	if (jetselection == "ge3t"):
# 		drawStackPlot("CFMlpANN_ge3t", pg, "ANN output >=3 tags", 10, 0.04, 0.84, lepselection, year, "draw")
...
# 	#drawStackPlot("fourth_jet_pt", pg, "fourth jet p_{T}", numBins, 20, 120, lepselection, year, "draw")
...
# 	#drawStackPlot("numAllJets", pg, "Good + bad jets", 18, 2, 20, lepselection, year, "draw")
...
# 	drawStackPlot("third_jet_pt", pg, "third_jet_pt", numBins, 20, 220, lepselection, year, "draw")
