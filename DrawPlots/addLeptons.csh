...
foreach jetCat ("eq2jeq2t" "ge3t")
  ...
  hadd -v 0 -f TwoLep/TwoLep_${year}_${mask}_${jetCat}_TwoLep.root MuonEle/MuEG_${year}_${mask}_${jetCat}_MuonEle.root TwoMuon/DoubleMu_${year}_${mask}_${jetCat}_TwoMuon.root TwoEle/DoubleElectron_${year}_${mask}_${jetCat}_TwoEle.root
  foreach sample ("singlet_s" "singlet_tW" "singlet_t" "singletbar_s" "singletbar_tW" "singletbar_t" "ttbarW" "ttbarZ" "ttbar_bb" "ttbar_cc" "ttbar" "wjets" "zjets" "zjets_lowmass" "ww" "wz" "zz" "ttH110" "ttH115" "ttH120" "ttH125" "ttH130" "ttH135" "ttH140")
    ...
    hadd -v 0 -f TwoLep/${sample}_${year}_${mask}_${jetCat}_TwoLep.root MuonEle/${sample}_${year}_${mask}_${jetCat}_MuonEle.root TwoMuon/${sample}_${year}_${mask}_${jetCat}_TwoMuon.root TwoEle/${sample}_${year}_${mask}_${jetCat}_TwoEle.root
  end
  echo "Removing cross sample files"
  rm -f TwoMuon/DoubleElectron_${year}_${mask}_${jetCat}_TwoMuon.root
  rm -f TwoMuon/MuEG_${year}_${mask}_${jetCat}_TwoMuon.root
  rm -f TwoEle/DoubleMu_${year}_${mask}_${jetCat}_TwoEle.root
  rm -f TwoEle/MuEG_${year}_${mask}_${jetCat}_TwoEle.root
  rm -f MuonEle/DoubleMu_${year}_${mask}_${jetCat}_MuonEle.root
  rm -f MuonEle/DoubleElectron_${year}_${mask}_${jetCat}_MuonEle.root
end	  
end
end
