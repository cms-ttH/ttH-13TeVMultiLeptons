...
##         drawStackPlot("prob1", pg, "prob1", numBins, 0, 2, lepselection)
##         drawStackPlot("prob2", pg, "prob2", numBins, 0, 2, lepselection)
##         drawStackPlot("probge3", pg, "probge3", numBins, 0, 2, lepselection)
