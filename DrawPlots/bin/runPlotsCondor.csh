...
HistosFromTreesBatch dilPlots_condor_cfg.py ${sample}  $iYear $iZmask $iLabel $iSkipSyst $iPV $iCharge > & ! $outDirName/dilAnalysis_${sample}_${iYear}_${iZmask}_${iLabel}_${iPV}_${iCharge}.log
