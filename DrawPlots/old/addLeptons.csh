...
#  hadd -v 0 -f SameLep/SameLep_${year}_${mask}_${jetCat}_SameLep.root TwoMuon/DoubleMu_${year}_${mask}_${jetCat}_TwoMuon.root TwoEle/DoubleElectron_${year}_${mask}_${jetCat}_TwoEle.root  
  ...
  foreach sample ("singlet_s" "singlet_tW" "singlet_t" "singletbar_s" "singletbar_tW" "singletbar_t" "ttbarW" "ttbarZ" "ttbar_bb" "ttbar_b" "ttbar_cc" "ttbar" "wjets" "zjets" "zjets_lowmass" "ww" "wz" "zz" "ttH110" "ttH115" "ttH120" "ttH125" "ttH130" "ttH135" "ttH140")
