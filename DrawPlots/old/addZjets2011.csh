...
foreach lepCat ("TwoMuon" "TwoEle" "MuonEle")
  ...
  foreach kind ("eq1t" "eq2jeq2t" "eq3jeq2t" "ge4jeq2t" "ge3t" )
    ...
    foreach jPart ("part1" "part2" "part3" "part4" "part5" "part6" "part7" "part8" "part9" "part10" "part11" "part12" "part13" "part14" "part15" "part16" "part17" "part18" )
       set ttbarPartString = "${ttbarPartString} ttbar_${jPart}_${year}_${zmask}_${kind}_${lepCat}.root" 
    end
